...
<div class="container">
    <div class="col-12 skills-area__container">
        <div class="col-4 col-sm-12 skills-area__skill">
            ...
            <a href="<?php echo get_theme_mod("first_skill_link", '');?>">
                <img src="<?php echo get_theme_mod("first_skill_image", "https://i1.wp.com/www.frauleinlouise.com/wp-content/uploads/2017/12/IMG_5852.jpg?resize=1200%2C800");?>"/>
            </a>
        ...
        <div class="col-4 col-sm-12 skills-area__skill">
            ...
            <a href="<?php echo get_theme_mod("second_skill_link");?>">
                <img src="<?php echo get_theme_mod("second_skill_image", "https://i2.wp.com/www.frauleinlouise.com/wp-content/uploads/2017/12/IMG_5853.jpg?resize=1200%2C800");?>"/>
            </a>
        ...
        <div class="col-4 col-sm-12 skills-area__skill">
            ...
            <a href="<?php echo get_theme_mod("third_skill_link");?>">
                <img src="<?php echo get_theme_mod("third_skill_image", "https://i2.wp.com/www.frauleinlouise.com/wp-content/uploads/2017/12/IMG_5864.jpg?resize=1200%2C800");?>"/>
            </a>
    ...
    <div class="col-10 align-center big-image-area__container hidden-xs">
        <div class="col-6">
            <img class="big-image-area__image" src="<?php echo get_theme_mod("big-image-link", "https://i1.wp.com/www.frauleinlouise.com/wp-content/uploads/2017/12/IMG_5852.jpg?resize=1200%2C800");?>"/>
        </div>
